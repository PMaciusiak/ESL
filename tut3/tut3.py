...
get_ipython().system('yosys -q -p "synth_ice40 -blif pwm_simple.blif" pwm_simple.v')
get_ipython().system('arachne-pnr -d 1k pwm_simple.blif -o pwm_simple.asc')
...
get_ipython().system('yosys -q -p "synth_ice40 -blif pwm_less_simple.blif" pwm_less_simple.v')
get_ipython().system('arachne-pnr -d 1k pwm_less_simple.blif -o pwm_less_simple.asc')
