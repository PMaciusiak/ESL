...
get_ipython().system('yosys -q -p "synth_ice40 -blif classic_fsm.blif" classic_fsm.v')
get_ipython().system('arachne-pnr -q -d 1k -p classic_fsm.pcf classic_fsm.blif -o classic_fsm.asc')
get_ipython().system('icepack classic_fsm.asc classic_fsm.bin')
get_ipython().system('iceprog classic_fsm.bin')
