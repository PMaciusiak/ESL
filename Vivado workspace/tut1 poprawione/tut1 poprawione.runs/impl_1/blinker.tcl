...
namespace eval ::optrace {
  variable script "Z:/ESL projects/tut1 poprawione/tut1 poprawione.runs/impl_1/blinker.tcl"
...
OPTRACE "add files" START { }
  add_files -quiet {{Z:/ESL projects/tut1 poprawione/tut1 poprawione.runs/synth_1/blinker.dcp}}
OPTRACE "read constraints: implementation" START { }
  read_xdc {{Z:/ESL projects/tut1 poprawione/tut1 poprawione.srcs/constrs_1/new/tut1 file idk.xdc}}
OPTRACE "read constraints: implementation" END { }
OPTRACE "add files" END { }
OPTRACE "link_design" START { }
  link_design -top blinker -part xc7z020clg484-1
...
OPTRACE "Post-Place Phys Opt Design: write_checkpoint" START { CHECKPOINT }
  write_checkpoint -force blinker_physopt.dcp
...
OPTRACE "read constraints: write_bitstream" END { }
  catch { write_mem_info -force -no_partial_mmi blinker.mmi }
