...
namespace eval ::optrace {
  variable script "Z:/ESL projects/project_6/project_6.runs/impl_1/ram.tcl"
...
OPTRACE "add files" START { }
  add_files -quiet {{Z:/ESL projects/project_6/project_6.runs/synth_1/ram.dcp}}
OPTRACE "read constraints: implementation" START { }
  read_xdc {{Z:/ESL projects/project_6/project_6.srcs/constrs_1/new/asdasd.xdc}}
OPTRACE "read constraints: implementation" END { }
OPTRACE "add files" END { }
OPTRACE "link_design" START { }
  link_design -top ram -part xc7z020clg484-1
...
OPTRACE "read constraints: write_bitstream" END { }
  catch { write_mem_info -force -no_partial_mmi ram.mmi }
